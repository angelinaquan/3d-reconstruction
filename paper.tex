...
This project was an equal collaboration. Both team members contributed to all aspects of the work, including codebase development, experiment design, results analysis, and paper writing. Specific areas of primary responsibility were split as follows:

\textbf{Angelina Quan}: Data pipeline and training infrastructure, loss function implementation, ablation experiment execution, results visualization, and primary writing of the Methodology, Experimental Results, and Discussion sections.

\textbf{Amy Liu}: Model architecture implementation, related work survey, encoder/decoder design decisions, qualitative analysis, and primary writing of the Introduction, Related Work, and Conclusion sections.
